            ...
            {activeStep === 0 && (
              <>
                <div className="flex justify-center p-4 m-2 flex-col">
                  ...
                  <label 
                    className="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold"
                    htmlFor="age">Date of birth</label>
                  <input
                    className="py-2 px-3 mb-3 h-8 rounded-lg border color-grey-100 mt-1 focus:outline-none focus:ring-2 focus:ring-#568EA3 focus:border-transparent"
                    type="date"
                    name="age"
                  ...
                  <div>
                    ...
                    <ul className="flex flex-row" >
                      {hobbies.map((hobbie, index) => (
                        <li 
                        className="mr-4 mb-4 bg-orange-200" 
                        key={index}>{hobbie}</li>
                      ))}
                    </ul>
                  </div>
            ...
            {activeStep === 1 && (
              <>
                <div className="flex justify-center p-4 m-2 flex-col">
                  ...
                  <label 
                    className="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold"
                    htmlFor="location">Current Location</label>
                  <input
                    className="py-2 px-3 mb-3 h-8 rounded-lg border color-grey-100 mt-1 focus:outline-none focus:ring-2 focus:ring-#568EA3 focus:border-transparent"
                    type="text"
                    name="location"
            ...
            {activeStep === 2 && (
              <>
                ...
                <div className="flex flex-col">
                  <h4
                    className="uppercase  text-s text-gray-600 text-light font-semibold"
                  >Education</h4>

                  <label 
                    className="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold"
                    htmlFor="place">Place</label>
                  <input
                    className="py-2 px-3 mb-3 h-8 rounded-lg border color-grey-100 mt-1 focus:outline-none focus:ring-2 focus:ring-#568EA3 focus:border-transparent"
                    type="text"
                    name="place"
                  ...
                  <button 
                    className="bg-gray-500 hover:bg-gray-700 rounded-lg shadow-xl font-medium text-white w-20 ml-4 h-8 mt-1 whitespace-nowrap"
                    onClick={handleSubmitEducation}>Add this</button>
                  ...
                  <ul>
                    {educations.map((edu, index) => (
                      ...
                      key={"edu-" + index}>
                        ...
                        <h5>{edu.degree}</h5>
                        <p
                        className="md:text-sm text-xs text-gray-500 text-light font-semibold"
                        >{`${moment(edu.startDate).format(
                          "MMM YYYY"
                        )} - ${moment(edu.endDate).format("MMM YYYY")}`}</p>
                      </li>
                    ))}
                  </ul>
                  </div>
                  ...
                  <div className="flex ml-16 flex-col">
                    ...
                    <button 
                      className="bg-gray-500 hover:bg-gray-700 rounded-lg shadow-xl font-medium text-white w-20 ml-4 h-8 mt-1 whitespace-nowrap"
                      onClick={handleSubmitExperience}>Add this</button>
            ...
            {activeStep === 3 && (
              <>
                <div className="flex justify-center p-4 m-2 flex-col">
                  ...
                  <label 
                    className="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold"
                    htmlFor="collLanguage">Choose the language</label>
                  <input
                    className="py-2 px-3 mb-3 h-8 rounded-lg border color-grey-100 mt-1 focus:outline-none focus:ring-2 focus:ring-#568EA3 focus:border-transparent"
                    type="text"
                    name="collLanguage"
                  ...
                  <div className="flex flex-col">
                      <label 
                        className="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold"
                        htmlFor="levelLanguage">Choose your level</label>
                    <div className="flex flex-row">
                      <input
                        className="py-2 px-3 mb-3 h-8 rounded-lg border color-grey-100 mt-1 focus:outline-none focus:ring-2 focus:ring-#568EA3 focus:border-transparent"
                        type="text"
                    ...
                    <button 
                      className="bg-gray-500 hover:bg-gray-700 rounded-lg shadow-xl font-medium text-white w-20 ml-4 h-8 mt-1 whitespace-nowrap"
                      onClick={handleLanguage}>Add this</button>
                  </div>
                    </div>
                  ...
                  <label 
                    className="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold"
                    htmlFor="skills">Professional skills</label>
                  <input
                    className="py-2 px-3 mb-3 h-8 rounded-lg border color-grey-100 mt-1 focus:outline-none focus:ring-2 focus:ring-#568EA3 focus:border-transparent"
                    type="text"
                    name="skills"
                  ...
                  <label 
                    className="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold"
                    htmlFor="video">
                    Here you can share the link to the video of your project
                    you proud of
                  </label>
            ...
            {activeStep === 4 && (
              <>
                <div className="flex justify-center p-4 m-2 flex-col">
                  ...
                  <label 
                    className="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold"
                    htmlFor="workingModal">Working Modal</label>
                  <input
                    className="py-2 px-3 mb-3 h-8 rounded-lg border color-grey-100 mt-1 focus:outline-none focus:ring-2 focus:ring-#568EA3 focus:border-transparent"
                    type="text"
                    name="workingModal"
                  ...
                  <label 
                  className="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold"
                  htmlFor="workingHours">Working Hours</label>
                  <input
                    className="py-2 px-3 mb-3 h-8 rounded-lg border color-grey-100 mt-1 focus:outline-none focus:ring-2 focus:ring-#568EA3 focus:border-transparent"
                    type="text"
                    name="workingHours"
                  ...
                  <label 
                    ...
                    htmlFor="salaryRange">Minimum Salary, $</label>
                  <input
                    className="py-2 px-3 mb-3 h-8 rounded-lg border color-grey-100 mt-1 focus:outline-none focus:ring-2 focus:ring-#568EA3 focus:border-transparent"
                    type="number"
                    name="salaryRange"

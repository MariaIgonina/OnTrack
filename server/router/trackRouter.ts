...
trackRouter.get("/getTracksByVacancy/:vacancyId",trackControllers.getTracksByVacancy);
trackRouter.get("/getTracksByRecruiter/:recruiterId",trackControllers.getTracksByRecruiter);
trackRouter.get("/getTracksByApplicant/:applicantId", trackControllers.getTracksByApplicant);
